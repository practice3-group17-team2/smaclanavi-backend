...
class TestSB(TestCase):
    ...
    def _test_get_area_urls(self):
        expected_dic = {
            ('13', '東京都'): {
                ...
                ('13', '131032'):
                'https://www.softbank.jp/shop/search/list/?spadv=on&pref=13&area=131032&cid=tpsk_191119_mobile',
                ('13', '131041'):
                'https://www.softbank.jp/shop/search/list/?spadv=on&pref=13&area=131041&cid=tpsk_191119_mobile',
            }
        }
    ...
    def _test_softbank_scrape(self):
        ...
        print(result)
        sb_savedata.save_data_to_pkl_file(
            result,
            file_path="softbank-{}".format(
...
class TestSoftBankLecInfoScraping(TestCase):
    ...
    def _test_get_lec_info_divs_by_class(self):
        class_id = "TD20"
        expected_data_text = "スマホ 体験編"
...
class TestURLNeedSele(TestCase):
    ...
    urls = {
        "softbank": {
            ...
            "lec_info": {
                "tmp":
                "https://spcr.reserve.mb.softbank.jp/spad-self/reservation/TD20"
            },
            "lec_schedule": {}
        },
        "docomo": {},
