...
class TestSB(TestCase):
    ...
    def _test_get_area_ids_by_pref(self):
        expected_dic = {('13', '東京都'): {('13', '131016'): '千代田区（4）',('13', '131024'): '中央区（5）',('13', '131032'): '港区（7）',('13', '131041'): '新宿区（9）',('13', '131059'): '文京区（2）',('13', '131067'): '台東区（4）',('13', '131075'): '墨田区（4）',('13', '131083'): '江東区（9）',('13', '131091'): '品川区（10 ）',('13', '131105'): '目黒区（5）',('13', '131113'): '大田区（11）',('13', '131121'): '世田谷区（15）',('13', '131130'): '渋谷区（6）',('13', '131148'): '中野区（4）',('13', '131156'): '杉並区（7）',('13', '131164'): '豊島区（8）',('13', '131172'): '北区（4）',('13', '131181'): '荒川区（4）',('13', '131199'): '板橋区（7）',('13', '131202'): '練馬区（9）',('13', '131211'): '足立区（8）',('13', '131229'): '葛飾区（5）',('13', '131237'): '江戸川区（8）',('13', '132012'): '八王子市（9）',('13', '132021'): '立川市（3）',('13', '132039'): '武蔵野市（4）',('13', '132047'): '三鷹市（1）',('13', '132055'): '青梅市（1）',('13', '132063'): '府中市（2）',('13', '132071'): '昭島市（1）',('13', '132080'): '調布市（4）',('13', '132098'): '町田市（8）',('13', '132101'): '小金井市（1）',('13', '132110'): '小平市（3）',('13', '132128'): '日野市（3）',('13', '132136'): '東村山市（3）',('13', '132144'): '国分寺市（3）',('13', '132152'): '国立市（2）',('13', '132187'): '福生市（1）',('13', '132195'): '狛江市（1）',('13', '132209'): '東大和市（1）',('13', '132217'): '清 瀬市（1）',('13', '132225'): '東久留米市（2）',('13', '132233'): '武蔵村山市（1）',('13', '132241'): '多摩市（3）',('13', '132250'): '稲城市（2）',('13', '132276'): '羽村市（2）',('13', '132284'): 'あきる野市（0）',('13', '132292'): '西東京市（3）',('13', '133035'): '西多摩郡瑞穂町（1）',('13', '133051'): '西多摩郡日の出町（1）',('13', '133078'): '西多摩郡檜原村（0）',('13', '133086'): '西多摩郡奥多摩町（0）',('13', '133612'): '大島町（0）',('13', '133621'): '利島村（0）',('13', '133639'): '新島村（0）',('13', '133647'): '神津島村（0）',('13', '133817'): '三宅村（0）',('13', '133825'): '御蔵島村（0）',('13', '134015'): '八丈町（0）',('13', '134023'): '青ヶ島村（0）',('13', '134210'): '小笠原村（0）'}}
        SBscraping.get_area_ids_by_pref(self.pref_key)
        result = SBscraping.show_sb_area_ids()
        # print(result)
        self.assertEqual(result, expected_dic)

    def _test_get_area_ids(self):
        expected_dic = {
            ('13','東京都'):{('13','131016'):'千代田区（4）',('13','131024'):'中央区（5）',('13','131032'):'港区（7）',('13','131041'):'新宿区（9）',('13','131059'):'文京区（2）',('13','131067'):'台東区（4）',('13','131075'):'墨田区（4）',('13','131083'):'江東区（9）',('13','131091'):'品川区（10）',('13','131105'):'目黒区（5）',('13','131113'):'大田区（11）',('13','131121'):'世田谷区（15）',('13','131130'):'渋谷区（6）',('13','131148'):'中野区（4）',('13','131156'):'杉並区（7）',('13','131164'):'豊島区（8）',('13','131172'):'北区（4）',('13','131181'):'荒川区（4）',('13','131199'):'板橋区（7）',('13','131202'):'練馬区（9）',('13','131211'):'足立区（8）',('13','131229'):'葛飾区（5）',('13','131237'):'江戸川区（8）',('13','132012'):'八王子市（9）',('13','132021'):'立川市（3）',('13','132039'):'武蔵野市（4）',('13','132047'):'三鷹市（1）',('13','132055'):'青梅市（1）',('13','132063'):'府中市（2）',('13','132071'):'昭島市（1）',('13','132080'):'調布市（4）',('13','132098'):'町田市（8）',('13','132101'):'小金井市（1）',('13','132110'):'小平市（3）',('13','132128'):'日野市（3）',('13','132136'):'東村山市（3）',('13','132144'):'国分寺市（3）',('13','132152'):'国立市（2）',('13','132187'):'福生市（1）',('13','132195'):'狛江市（1）',('13','132209'):'東大和市（1）',('13','132217'):'清瀬市（1）',('13','132225'):'東久留米市（2）',('13','132233'):'武蔵村山市（1）',('13','132241'):'多摩市（3）',('13','132250'):'稲城市（2）',('13','132276'):'羽村市（2）',('13','132284'):'あきる野市（0）',('13','132292'):'西東京市（3）',('13','133035'):'西多摩郡瑞穂町（1）',('13','133051'):'西多摩郡日の出町（1）',('13','133078'):'西多摩郡檜原村（0）',('13','133086'):'西多摩郡奥多摩町（0）',('13','133612'):'大島町（0）',('13','133621'):'利島村（0）',('13','133639'):'新島村（0）',('13','133647'):'神津島村（0）',('13','133817'):'三宅村（0）',('13','133825'):'御蔵島村（0）',('13','134015'):'八丈町（0）',('13','134023'):'青ヶ島村（0）',('13','134210'):'小笠原村（0）'},
            ('14','神奈川県'):{('14','141011'):'横浜市鶴見区（2）',('14','141020'):'横浜市神奈川区（2）',('14','141038'):'横浜市西区（5）',('14','141046'):'横浜市中区（3）',('14','141054'):'横浜市南区（0）',('14','141062'):'横浜市保土ケ谷区（1）',('14','141071'):'横浜市磯子区（2）',('14','141089'):'横浜市金沢区（3）',('14','141097'):'横浜市港北区（6）',('14','141101'):'横浜市戸塚区（3）',('14','141119'):'横浜市港南区（3）',('14','141127'):'横浜市旭区（3）',('14','141135'):'横浜市緑区（2）',('14','141143'):'横浜市瀬谷区（1）',('14','141151'):'横浜市栄区（0）',('14','141160'):'横浜市泉区（1）',('14','141178'):'横浜市青葉区（4）',('14','141186'):'横浜市都筑区（5）',('14','141313'):'川崎市川崎区（3）',('14','141321'):'川崎市幸区（2）',('14','141330'):'川崎市中原区（4）',('14','141348'):'川崎市高津区（2）',('14','141356'):'川崎市多摩区（3）',('14','141364'):'川崎市宮前区（2）',('14','141372'):'川崎市麻生区（1）',('14','141518'):'相模原市緑区（4）',('14','141526'):'相模原市中央区（5）',('14','141534'):'相模原市南区（2）',('14','142018'):'横須賀市（5）',('14','142034'):'平塚市（4）',('14','142042'):'鎌倉市（2）',('14','142051'):'藤沢市（6）',('14','142069'):'小田原市（4）',('14','142077'):'茅ヶ崎市（2）',('14','142085'):'逗子市（1）',('14','142107'):'三浦市（0）',('14','142115'):'秦野市（1）',('14','142123'):'厚木市（4）',('14','142131'):'大和市（4）',('14','142140'):'伊勢原市（2）',('14','142158'):'海老名市（2）',('14','142166'):'座間市（2）',('14','142174'):'南足柄市（0）',('14','142182'):'綾瀬市（1）',('14','143014'):'三浦郡葉山町（0）',('14','143219'):'高座郡寒川町（1）',('14','143413'):'中郡大磯町（0）',('14','143421'):'中郡二宮町（0）',('14','143618'):'足柄上郡中井町（0）',('14','143626'):'足柄上郡大井町（1）',('14','143634'):'足柄上郡松田町（0）',('14','143642'):'足柄上郡山北町（0）',('14','143669'):'足柄上郡開成町（0）',('14','143821'):'足柄下郡箱根町（0）',('14','143839'):'足柄下郡真鶴町（0）',('14','143847'):'足柄下郡湯河原町（0）',('14','144011'):'愛甲郡愛川町（1）',('14','144029'):'愛甲郡清川村（0）'}
        }
    ...
    def _test_get_shop_urls(self):
        expected_dic = {
            ('13','東京都'):{(('13','131016'),'千代田区（4）'):[],(('13','131024'),'中央区（5）'):['https://www.softbank.jp/shop/search/detail/TD31/?cid=tpsk_191119_mobile']},
            ('14','神奈川県'):{(('14','141011'),'横浜市鶴見区（2）'):['https://www.softbank.jp/shop/search/detail/T216/?cid=tpsk_191119_mobile'],(('14','141020'),'横浜市神奈川区（2）'):[]}
        }
    ...
    def _test_get_shop_infos_by_area(self):
    ...
    def _test_get_shop_info_from_url(self):
        expected_dic = {
            ...
            'site_url': "https://www.softbank.jp/shop/search/detail/T1G0/"
        }
    ...
    def _test_softbank_scrape(self):
        """ 
        ...
        print(result)
        SBscraping.save_data_file_pkl(result, file_path="softbank-{}".format(datetime.datetime.now().strftime('%Y_%m_%d_%H_%M_%S')))
    ...
    def _test_save_load_by_pkl(self):
        ...
        SBscraping.save_data_file_pkl(dic, file_name)
        load_dic = SBscraping.load_data_file_pkl(file_name)
