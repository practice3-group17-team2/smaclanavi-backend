...
class City(models.Model):
    ...
    prefecture = models.ForeignKey(Prefecture, blank=True, on_delete=models.SET_DEFAULT, default=1)
...
class ClassInfo(models.Model):
    ...
    city         = models.ForeignKey(City, blank=True, on_delete=models.SET_DEFAULT, default=1)
